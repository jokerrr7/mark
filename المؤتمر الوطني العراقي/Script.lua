...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/MARK_Kk"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : MARK_Kk](https://t.me/MARK_Kk)' ,nil,inline,msg.id_)
return false
end
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = 'مطور السورس.',url="https://t.me/ITALY4_6"},
{text = '- قناة السورس',url="https://t.me/MARK_5"}},
}   
send_inline(msg.chat_id_,  "سورس مارك 🔥" ,keyboard,'html')
end
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/MARK_Kk) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/MARK_Kk)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/MARK_Kk)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/MARK_Kk)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/MARK_Kk)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/MARK_Kk) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/MARK_Kk)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/MARK_Kk)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/MARK_Kk)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/MARK_Kk)")
